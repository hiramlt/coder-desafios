...
// Desafio Coderhouse - Manejo de archivos
// Hiram Lache Toledo
...
class ProductManager{
    ...
    async #setProductId() {  //Obtiene un ID unico para un producto
...
(async function Test(run) {
    const pm = new ProductManager('./desafio-manejo-archivos/test.txt');
    console.log(await pm.getProducts());
    //await pm.addProducts("Producto prueba", "Este es un producto de prueba", 200, "Sin imagen", "abc123", 25);
    //console.log(await pm.getProducts());
